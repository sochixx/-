...
int main()
{
    ...
    while (true)
    {
        ...
        case 1:
            ...
            cout << "Для перехода к меню введите любое число: ";
            cin >> temp;
            system("cls");
            break;
        case 2:
        ...
        case 3:
            while (temp == 1)
            {
                ...
                cout << "Если вы хотите найти корни ещё одного уравнения, введите 1. Для перехода к меню введите любое другое значение: ";
                cin >> temp;
                system("cls");
            }
            break;
